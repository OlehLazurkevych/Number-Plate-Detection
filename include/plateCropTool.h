...
private:
	const int VERTICAL_PEAK_QUANTITY   = 3; // 3
	const int HORIZONTAL_PEAK_QUANTITY = 3;	// 2
	const int VERTICAL_RANK_SIZE       = 9;	// 9
	const int DERIVE_FUNC_COEF         = 4;	// 4

	const double VERTICAL_CLIP_COEF   = 0.55; // 0.55
	const double HORIZONTAL_CLIP_COEF = 0.33; // 0.33
	const double FIRST_PEAK_COEF      = 0.42; // 0.42
	const double HORIZONTAL_RANK_COEF = 3.2;  // 3.2
